  ...
  return (
    <div className="space-y-5">
      ...
      <div className="card flex items-center gap-4 p-5">
        <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-primary-soft font-heading text-xl font-extrabold text-primary">
          {initial}
        </span>
      ...
      <div className="card p-5">
        <div className="mb-3 flex items-end justify-between gap-3">
          <div>
            ...
            <p className={`text-sm font-semibold ${bandTextClass}`}>
              {band.label} güven
            </p>
          </div>
          <span
            className={`font-heading text-4xl font-extrabold tabular-nums ${bandTextClass}`}
          >
            %{trust.score}
          </span>
        </div>
        ...
        {trust.missing.length > 0 && (
          <p className="mt-3 text-sm text-muted">
            <span className="font-medium text-ink">Eksik:</span>{" "}
              ...
              <div>
                ...
                <div className="space-y-2.5">
                  {banks.map((b) => (
                    <div
                      key={b.id}
                      className="flex items-center gap-3 rounded-[var(--app-radius)] border border-line p-4"
                    >
